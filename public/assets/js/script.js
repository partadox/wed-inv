...
/*------------------------------------------
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2023/02/17', function(event) {
    ...
    -------------------------------------------*/
    if ($("#clock2").length) {
        $('#clock2').countdown('2023/02/17', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div><div class="time">%m</div> <span>Month</span> </div></div>'
            + '<div class="box"><div><div class="time">%D</div> <span>Days</span> </div></div>'
            + '<div class="box"><div><div class="time">%H</div> <span>Hours</span> </div></div>'
    ...
    if ($("#contact-form-main").length) {
        $("#contact-form-main").validate({
            ...
            messages: {
                name: "Harap isikan nama anda.",
                kehadiran: "Harap isikan kehadiran anda.",
                ucapan: "Harap tulis ucapan.",
            },

            submitHandler: function (form) {
                $.ajax({
                    type: "POST",
                    url: "home/simpan_ucapan77",
                    data: {
                        name: $('input#name').val(),
                        kehadiran: $('select#kehadiran').val(),
